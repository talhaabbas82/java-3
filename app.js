...
if (value>100){
    ...
    alert("this value is less than 100.");
} else {
    alert("this value is exactly 100.");
}
...
if (first>second){
    alert("first value is bigger.");
} else if(first<second){
    alert("second value is smaller.");
} else {
    alert("both value are equally");
}
...
if (num % 3 === 0){
    alert("this value is divsible by 3");
} else {
    alert("this value is not divisible by 3");
}
...
if (num % 5 === 0){
    alert("this value is divisible by 5");
} else {
    alert("this value is not divisible by 5");
}
